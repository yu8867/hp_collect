    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        <p className="text-slate-300 text-lg md:text-xl max-w-2xl mx-auto mb-12 font-light leading-relaxed">
          Googleの最新AIを駆使し、構想からローンチまで<span className="text-white font-bold">最短3日</span>。<br className="hidden md:block" />
          従来の制作プロセスの「無駄」を極限まで削ぎ落とし、<br className="hidden md:block" />
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          >
            <span className="relative z-10 flex items-center justify-center gap-2">
              制作実績を見る <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </span>
