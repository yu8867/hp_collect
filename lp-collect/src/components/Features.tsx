...
const features: FeatureItem[] = [
  {
    title: "常識を覆すスピード",
    description:
      "従来の開発なら数週間かかる工程を、Geminiを用いたコード生成とImagenによる素材生成で「数日」に短縮。テストマーケティングを急ぐあなたのためのスピード感です。",
    icon: Rocket,
  ...
  },
  {
    title: "AI × プロのクオリティ",
    description:
      "AIが骨組みを作り、経験豊富なWebディレクターが魂を吹き込む。細部のUI調整や、人の心を動かすコピーライティングはプロの手で完璧に仕上げます。",
    icon: Brain,
  ...
  },
  {
    ...
    description:
      "人件費のかかる単純作業をAIに任せることで、開発コストを劇的に削減。浮いた予算を広告費やプロダクト改善に回せる、賢い選択肢を提供します。",
    icon: Wallet,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div
                className={`w-14 h-14 rounded-lg bg-white/5 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}
              >
